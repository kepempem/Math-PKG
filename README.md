...
+ [Math-PKG](#math-pkg)
    ...
    + [Complex Numbers](#complex-numbers)
        ...
        + [Getters](#getters)
            ...
            + [Complex.abs](#complexabs)
            + [Complex.ln](#complexln)
            + [Complex.cos](#complexcos)
            + [Complex.sin](#complexsin)
            + [Complex.tan](#complextan)
            + [Complex.cis](#complexcis)
            + [Complex.factorial](#complexfactorial)
        ...
        + [Methods](#methods)
            ...
            + [Complex.log(number/Complex b)](#complexlognumbercomplex-b)
